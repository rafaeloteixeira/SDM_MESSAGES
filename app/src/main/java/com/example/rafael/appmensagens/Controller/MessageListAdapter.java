...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    private List<Mensagem> mMessageList;

    public MessageListAdapter(Context context, List<Mensagem> messageList) {
        mContext = context;
    ...
    public int getItemViewType(int position) {
        Mensagem message = (Mensagem) mMessageList.get(position);

        if (message.getOrigemId().equals(UsuarioController.getInstance().getUsuarioLogado().getId())) {
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Mensagem message) {
            ...
            //timeText.setText(message.getAssunto());
